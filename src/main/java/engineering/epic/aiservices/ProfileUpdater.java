...
public interface ProfileUpdater {
    @SystemMessage("""
            ...
            Depending on what info you can retrieve for the conversation, you can call one or more of the following tools: addPreferredProducts, updateBudgetType (normal, discount or credit), addPassions, addSensitivities, addImpulseBuyingProducts or addExtraInfo.
