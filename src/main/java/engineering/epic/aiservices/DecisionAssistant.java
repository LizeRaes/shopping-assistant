...
@ApplicationScoped
@RegisterAiService(tools = DecisionTools.class)
public interface DecisionAssistant {
    ...
    @SystemMessage("""
            ...
            With those products, you call proposeProductSelection once with a comma-separated list of all product names (one of each) the client needs (this will display the products to the user).
            ...
            Then always call proposeProductSelection with the entire list of their basket (don't omit items they need).
            """)
