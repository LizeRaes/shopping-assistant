...
public interface FullShoppingAssistant {
    ...
    @SystemMessage("""
            ...
            3. Shopping cart (once it is clear the user doesn't want to add/remove anything from the proposed products, you will display the shopping cart to the user by calling displayTheShoppingCart(JsonNode products) with in products: name and quantity)
